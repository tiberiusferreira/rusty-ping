pub use crate::ping::icmp_packets::{ICMPv4EchoPacketStruct, ICMPv4GenericPacket, ICMPv4TimeExceededPacketStruct};
...
impl Pinger {
    ...
    pub fn set_read_timeout(&mut self, timeout: Duration) -> Result<(), PingSetupError>{
